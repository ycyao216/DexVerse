...
"""Push-button base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import pushbutton_cfg
...
_PUSHBUTTON_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_PUSHBUTTON_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_PUSHBUTTON_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_PUSHBUTTON_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class PushButtonWithRigidAddonEnvCfg(pushbutton_cfg.PushButtonEnvCfg):
    """Composable push-button env with one rigid addon."""
...
@configclass
class PushButtonPickUpCanEnvCfg(PushButtonWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _PUSHBUTTON_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class PushButtonPickUpStickEnvCfg(PushButtonWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _PUSHBUTTON_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class PushButtonPourMugEnvCfg(PushButtonWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _PUSHBUTTON_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class PushButtonRelocateSphereEnvCfg(PushButtonWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _PUSHBUTTON_RELOCATE_SPEC
