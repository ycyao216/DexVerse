...
"""Rotate-knob base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import rotateknob_cfg
...
_ROTATEKNOB_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_ROTATEKNOB_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_ROTATEKNOB_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_ROTATEKNOB_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class RotateKnobWithRigidAddonEnvCfg(rotateknob_cfg.RotateKnobEnvCfg):
    """Composable rotate-knob env with one rigid addon."""
...
@configclass
class RotateKnobPickUpCanEnvCfg(RotateKnobWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _ROTATEKNOB_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class RotateKnobPickUpStickEnvCfg(RotateKnobWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _ROTATEKNOB_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class RotateKnobPourMugEnvCfg(RotateKnobWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _ROTATEKNOB_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class RotateKnobRelocateSphereEnvCfg(RotateKnobWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _ROTATEKNOB_RELOCATE_SPEC
