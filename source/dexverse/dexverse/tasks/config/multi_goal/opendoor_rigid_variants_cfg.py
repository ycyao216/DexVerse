...
"""Open-door base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import opendoor_cfg
...
_OPEN_DOOR_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_OPEN_DOOR_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_OPEN_DOOR_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_OPEN_DOOR_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class OpenDoorWithRigidAddonEnvCfg(opendoor_cfg.OpenDoorEnvCfg):
    """Composable open-door env with one rigid addon."""
...
@configclass
class OpenDoorPickUpCanEnvCfg(OpenDoorWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DOOR_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class OpenDoorPickUpStickEnvCfg(OpenDoorWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DOOR_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class OpenDoorPourMugEnvCfg(OpenDoorWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DOOR_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class OpenDoorRelocateSphereEnvCfg(OpenDoorWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DOOR_RELOCATE_SPEC
