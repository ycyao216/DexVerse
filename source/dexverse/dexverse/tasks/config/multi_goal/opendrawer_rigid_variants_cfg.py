...
"""Open-drawer base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import opendrawer_cfg
...
_OPEN_DRAWER_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_OPEN_DRAWER_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_OPEN_DRAWER_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_OPEN_DRAWER_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class OpenDrawerWithRigidAddonEnvCfg(opendrawer_cfg.OpenDrawerEnvCfg):
    """Composable open-drawer env with one rigid addon."""
...
@configclass
class OpenDrawerPickUpCanEnvCfg(OpenDrawerWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DRAWER_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class OpenDrawerPickUpStickEnvCfg(OpenDrawerWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DRAWER_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class OpenDrawerPourMugEnvCfg(OpenDrawerWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DRAWER_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class OpenDrawerRelocateSphereEnvCfg(OpenDrawerWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_DRAWER_RELOCATE_SPEC
