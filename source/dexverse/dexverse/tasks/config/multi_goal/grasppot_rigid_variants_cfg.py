...
"""Grasp-pot base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import grasppot_cfg
...
_GRASPPOT_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_GRASPPOT_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_GRASPPOT_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_GRASPPOT_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class GraspPotWithRigidAddonEnvCfg(grasppot_cfg.GraspPotEnvCfg):
    """Composable grasp-pot env with one rigid addon."""
...
@configclass
class GraspPotPickUpCanEnvCfg(GraspPotWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPPOT_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class GraspPotPickUpStickEnvCfg(GraspPotWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPPOT_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class GraspPotPourMugEnvCfg(GraspPotWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPPOT_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class GraspPotRelocateSphereEnvCfg(GraspPotWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPPOT_RELOCATE_SPEC
