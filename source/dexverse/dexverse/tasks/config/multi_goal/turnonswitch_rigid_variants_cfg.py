...
"""Turn-on-switch base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import turnonswitch_cfg
...
_TURNONSWITCH_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_TURNONSWITCH_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_TURNONSWITCH_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_TURNONSWITCH_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class TurnOnSwitchWithRigidAddonEnvCfg(turnonswitch_cfg.TurnOnSwitchEnvCfg):
    """Composable turn-on-switch env with one rigid addon."""
...
@configclass
class TurnOnSwitchPickUpCanEnvCfg(TurnOnSwitchWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _TURNONSWITCH_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class TurnOnSwitchPickUpStickEnvCfg(TurnOnSwitchWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _TURNONSWITCH_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class TurnOnSwitchPourMugEnvCfg(TurnOnSwitchWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _TURNONSWITCH_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class TurnOnSwitchRelocateSphereEnvCfg(TurnOnSwitchWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _TURNONSWITCH_RELOCATE_SPEC
