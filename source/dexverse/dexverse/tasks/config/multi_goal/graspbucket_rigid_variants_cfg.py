...
"""Grasp-bucket base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import graspbucket_cfg
...
_GRASPBUCKET_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_GRASPBUCKET_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_GRASPBUCKET_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_GRASPBUCKET_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class GraspBucketWithRigidAddonEnvCfg(graspbucket_cfg.GraspBucketEnvCfg):
    """Composable grasp-bucket env with one rigid addon."""
...
@configclass
class GraspBucketPickUpCanEnvCfg(GraspBucketWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPBUCKET_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class GraspBucketPickUpStickEnvCfg(GraspBucketWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPBUCKET_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class GraspBucketPourMugEnvCfg(GraspBucketWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPBUCKET_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class GraspBucketRelocateSphereEnvCfg(GraspBucketWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _GRASPBUCKET_RELOCATE_SPEC
