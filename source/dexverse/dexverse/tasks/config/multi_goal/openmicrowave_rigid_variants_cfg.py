...
"""Open-microwave base with swappable rigid-object variants."""

from dexverse.tasks.config.articulation import openmicrowave_cfg
...
_OPEN_MICROWAVE_CAN_SPEC = RigidAddonSpec(
    scene_name="can",
...
_OPEN_MICROWAVE_STICK_SPEC = RigidAddonSpec(
    scene_name="stick",
...
_OPEN_MICROWAVE_MUG_SPEC = RigidAddonSpec(
    scene_name="mug",
...
_OPEN_MICROWAVE_RELOCATE_SPEC = RigidAddonSpec(
    scene_name="sphere",
...
@configclass
class OpenMicrowaveWithRigidAddonEnvCfg(openmicrowave_cfg.OpenMicrowaveEnvCfg):
    """Composable open-microwave env with one rigid addon."""
...
@configclass
class OpenMicrowavePickUpCanEnvCfg(OpenMicrowaveWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_MICROWAVE_CAN_SPEC
    rigid_obs_source = _PICKUP_CAN_OBS


@configclass
class OpenMicrowavePickUpStickEnvCfg(OpenMicrowaveWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_MICROWAVE_STICK_SPEC
    rigid_obs_source = _PICKUP_STICK_OBS


@configclass
class OpenMicrowavePourMugEnvCfg(OpenMicrowaveWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_MICROWAVE_MUG_SPEC
    rigid_obs_source = _POUR_MUG_OBS


@configclass
class OpenMicrowaveRelocateSphereEnvCfg(OpenMicrowaveWithRigidAddonEnvCfg):
    rigid_addon_spec: RigidAddonSpec | None = _OPEN_MICROWAVE_RELOCATE_SPEC
